...
try
  ...
  disp('WARNING: Unable to compile mex files required by foreground highlighting, please switch it off by setting the use_fg_high field in parsing parameters to false, or try again with a different compiler');
end
try
