function Img = DrawLineOnImg(Img, X0, Y0, X1, Y1, nG)
...
% Version 1.0
%
% Vittorio Ferrari updated it to clipping !
%

siz = [size(Img,1)-1 size(Img,2)-1];
% x,y coords are inverted ! in some rare cases algo enlarges Img (!)
% better be conservative in clipping !
[X0 Y0] = ClipPoint(X0, Y0, [2 2 siz]);
[X1 Y1] = ClipPoint(X1, Y1, [2 2 siz]);
